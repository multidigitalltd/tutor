	...
	private function create_chapters( int $unit_id ): void {
		$chapters = array(
			array(
				...
				'tasks' => array(
					array(
						'title'        => 'משימה 1: מה אתה מקדם?',
						'instruction'  => 'כתוב במשפט אחד ברור מה בדיוק המוצר או השירות שאתה רוצה לקדם בקמפיין.',
						'button_label' => '',
						'allow_file'   => true,
					),
					array(
						'title'        => 'משימה 2: מה הלקוח צריך להבין?',
						'instruction'  => 'כתוב מה הדבר המרכזי שהלקוח אמור להבין תוך 5 שניות כשהוא רואה את הפרסום שלך.',
						'button_label' => '',
						'allow_file'   => true,
					),
					array(
						'title'        => 'משימה 3: איזו בעיה אתה פותר?',
						'instruction'  => 'כתוב איזו בעיה, צורך או כאב של הלקוח המוצר / השירות שלך פותר.',
						'button_label' => '',
						'allow_file'   => true,
					),
					array(
						'title'        => 'משימה 4: ניסוח מסר ראשוני',
						'instruction'  => 'נסח טיוטה ראשונית למסר המרכזי של הקמפיין. אפשר לכתוב את הנוסח בתיבת הטקסט או לצרף קובץ עם טיוטת מודעה / מצגת / בריף.',
						'button_label' => '',
						'allow_file'   => true,
					),
				),
			...
			array(
				...
				'tasks' => array(
					array(
						'title'        => 'משימה 1: מה לא ברור במסר שלך?',
						'instruction'  => 'כתוב אילו חלקים במסר הנוכחי שלך עלולים להיות לא ברורים ללקוח שלא מכיר אותך.',
						'button_label' => '',
						'allow_file'   => true,
					),
					array(
						'title'        => 'משימה 2: גרסה פשוטה יותר',
						'instruction'  => 'נסח את המסר שלך מחדש בשפה פשוטה יותר, כאילו אתה מסביר אותו ללקוח שלא מכיר את התחום.',
						'button_label' => '',
						'allow_file'   => true,
					),
				),
